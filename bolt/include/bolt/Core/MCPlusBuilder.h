...
public:
  ...
  virtual InstructionListType createCmpJEWithReg(MCPhysReg Reg1, MCPhysReg Reg2,
                                                 const MCSymbol *Target,
                                                 MCContext *Ctx) const {
    llvm_unreachable("not implemented");
    return {};
  ...
  virtual InstructionListType createCmpJNEWithReg(MCPhysReg Reg1, MCPhysReg Reg2,
                                                  const MCSymbol *Target,
                                                  MCContext *Ctx) const {
    llvm_unreachable("not implemented");
    return {};
